...
// ---- Form XI (latest club-season performance snapshot) ----
const BEST_XI = {
  formation: "4-3-3",
  asOf: "2026-05-26",
  players: [
    {name:"Thibaut Courtois", pos:"GK", teamId:"bel", x:50, y:90},
    {name:"Achraf Hakimi", pos:"RB", teamId:"mar", x:80, y:72},
    {name:"Virgil van Dijk", pos:"CB", teamId:"ned", x:60, y:74},
    {name:"Rúben Dias", pos:"CB", teamId:"por", x:40, y:74},
    {name:"Theo Hernández", pos:"LB", teamId:"fra", x:20, y:72},
    {name:"Rodri", pos:"CM", teamId:"esp", x:50, y:58},
    {name:"Jude Bellingham", pos:"CM", teamId:"eng", x:33, y:54},
    {name:"Pedri", pos:"CM", teamId:"esp", x:67, y:54},
    {name:"Lamine Yamal", pos:"RW", teamId:"esp", x:78, y:36},
    {name:"Kylian Mbappé", pos:"ST", teamId:"fra", x:50, y:28},
    {name:"Vinícius Jr.", pos:"LW", teamId:"bra", x:22, y:36},
  ]
};
